...
public class ConverterTest {
    ...
    @Test
    public void getRsaPublicKeyWithSingleRsaJwkInputReturnsListWithSingleRsaPublicKeyObject()
    ...
    @Test
    public void getRsaPublicKeyWithTwoKeysRsaAndEcJwkInputReturnsListWithSingleRsaPublicKeyObject()
            throws NoSuchAlgorithmException, InvalidKeySpecException, ParseException {
        Object jwk = new JSONParser()
    ...
    @Test
    public void getRsaPublicKeyWithTwoRsaJwkInputReturnsListWithTwoRsaPublicKeyObjects()
            throws NoSuchAlgorithmException, InvalidKeySpecException, ParseException {
        Object jwk = new JSONParser()
        ...
        PublicKey publicKey2 = KeyFactory.getInstance("RSA").generatePublic(
                new RSAPublicKeySpec(modulus2, publicExponent2));
    ...
    @Test
    public void getRsaPublicKeyByPkcs8PemStringReturnsCorrectRsaPublicKeyObject() throws NoSuchAlgorithmException,
        ...
        RSAPublicKey expectedPublicKey = (RSAPublicKey) KeyFactory.getInstance("RSA").generatePublic(
                new RSAPublicKeySpec(modulus, publicExponent));
    ...
    @Test
    public void getRsaPublicKeyByPkcs1PemStringReturnsCorrectRsaPublicKeyObject() throws NoSuchAlgorithmException,
            InvalidKeySpecException, ParseException {
        String pemString = "-----BEGIN PUBLIC KEY-----\n"
