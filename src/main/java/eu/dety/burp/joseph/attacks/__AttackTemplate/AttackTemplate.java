...
public class AttackTemplate implements IAttack {
    ...
    private AttackTemplateInfo attackInfo;
    private IBurpExtenderCallbacks callbacks;
    private AttackerResultWindow attackerResultWindow;
    private List<IHttpRequestResponse> responses = new ArrayList<>();
    private IHttpService httpService;

    public AttackTemplate(IBurpExtenderCallbacks callbacks, AttackTemplateInfo attackInfo) {
    ...
    public void performAttack() {
        ...
        for (AttackTemplateAttackRequest attackRequest : this.attackInfo.getRequests()) {
    ...
    private class AttackExecutor extends SwingWorker<IHttpRequestResponse, Integer> {
        private AttackTemplateAttackRequest attackRequest;

        AttackExecutor(AttackTemplateAttackRequest attackRequest) {
