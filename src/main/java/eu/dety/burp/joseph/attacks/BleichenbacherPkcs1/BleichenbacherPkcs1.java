...
public class BleichenbacherPkcs1 implements IAttack {
    ...
    public void performDecryptionAttack() {
        ...
        decryptionAttackWorker = new BleichenbacherPkcs1DecryptionAttackExecutor(this.decryptionAttackPanel, callbacks, attackInfo.getPublicKey(), attackInfo.getRequestResponse(), attackInfo.getParameter(), oracle, true);
