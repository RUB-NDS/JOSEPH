...
public class ManualPanel extends javax.swing.JPanel {
                        ...
                        layout.createSequentialGroup()
                                ...
                                .addGroup(
                                        layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 790,
                                                        Short.MAX_VALUE)
                                                .addGroup(
                                                        layout.createSequentialGroup()
                                                                .addGroup(
    ...
    private void loadJoseButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_loadJoseButtonActionPerformed
        ...
        if (!inputValueText.isEmpty()) {
            try {
                ...
                JOptionPane.showMessageDialog(new JFrame(), e.getMessage(), bundle.getString("INVALID_JOSE_VALUE")
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_updateButtonActionPerformed
        ...
        if (joseValue.getJoseType().equals(JoseParameter.JoseType.JWS)) {
            ...
            try {
                loggerInstance.log(selectedAttack.getClass(),
                        "Selected payload: " + payloadSelectionListModel.getSelectedItem(), Logger.LogLevel.DEBUG);
                HashMap<String, String> updatedValues = selectedAttack.updateValuesByPayload(
                        payloads.get(payloadSelectionListModel.getSelectedItem()), header, payload, signature);

                loggerInstance.log(selectedAttack.getClass(), "Values: " + updatedValues.get("header") + "; "
                        + updatedValues.get("payload") + "; " + updatedValues.get("signature"), Logger.LogLevel.DEBUG);
                ...
                JOptionPane.showMessageDialog(new JFrame(), e.getMessage(),
                        bundle.getString("ATTACK_PREPARATION_FAILED"), JOptionPane.ERROR_MESSAGE);
                loggerInstance.log(selectedAttack.getClass(), e.getMessage(), Logger.LogLevel.ERROR);
            }
        } else {
            JOptionPane.showMessageDialog(new JFrame(), bundle.getString("NOT_YET_SUPPORTED_MSG"),
                    bundle.getString("NOT_YET_SUPPORTED"), JOptionPane.ERROR_MESSAGE);
            loggerInstance.log(selectedAttack.getClass(), bundle.getString("NOT_YET_SUPPORTED_MSG"),
