    ...
    private void initComponents() {
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(extraPanel, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                ...
                                                javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(updateButton))
        ...
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18).addComponent(updateButton).addContainerGap(180, Short.MAX_VALUE)));
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_updateButtonActionPerformed
        ...
        try {
            HashMap<String, String> updatedValues = selectedAttack.updateValuesByPayload(
                    payloads.get(payloadSelectionListModel.getSelectedItem()), this.header, this.payload,
                    this.signature);
            this.jwsEditorReference.updateSourceViewer(updatedValues.get("header"), updatedValues.get("payload"),
                    updatedValues.get("signature"));
