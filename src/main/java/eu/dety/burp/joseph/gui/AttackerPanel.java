...
public class AttackerPanel extends JPanel {
    ...
    public AttackerPanel(IBurpExtenderCallbacks callbacks, IHttpRequestResponse message) {
        ...
        if (joseJSONComponents[0].has("alg"))
            algorithm = joseJSONComponents[0].getString("alg");
        if (joseJSONComponents[0].has("typ"))
            type = joseJSONComponents[0].getString("typ");
        ...
        loggerInstance.log(getClass(), "JOSE PARAMETER Value (JSON Parsed) " + joseJSONComponents[0].toString() + " . " + joseJSONComponents[1].toString()
                + " . " + joseJSONComponents[2].toString(), Logger.LogLevel.DEBUG);
        ...
        // Disable attackList and loadButton with short information if no
        // suitable attack is available
                                ...
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(
                                                layout.createSequentialGroup()
                                                        ...
                                                        .addComponent(typeValue, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18).addComponent(algorithmLabel)
                                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(algorithmValue))
                                        ...
                                        .addComponent(extraPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(attackButton)).addContainerGap(261, Short.MAX_VALUE)));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(typeLabel).addComponent(algorithmLabel)
                                        .addComponent(typeValue).addComponent(algorithmValue))
                        .addGap(18, 18, 18)
                        .addComponent(attackListLabel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(extraPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18).addComponent(attackButton).addContainerGap(120, Short.MAX_VALUE)));
