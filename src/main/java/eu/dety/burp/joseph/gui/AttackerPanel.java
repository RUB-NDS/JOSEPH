...
public class AttackerPanel extends JPanel {
     ...
     * <p>
     * Register available attacks, extract "alg" and "typ" header fields and generate
     * attackListModel based on type and suitableness of the attack.
     * 
     * @param callbacks
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(extraPanel, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                ...
                                                javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(attackButton))
                ...
                layout.createSequentialGroup()
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(typeLabel).addComponent(algorithmLabel).addComponent(typeValue)
                                        .addComponent(algorithmValue))
                        .addGap(18, 18, 18)
                        .addComponent(attackListLabel)
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(attackList, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                        ...
                        .addGap(18, 18, 18).addComponent(attackButton).addContainerGap(120, Short.MAX_VALUE)));

        attackInfoName.getAccessibleContext().setAccessibleName("attackInfoName");
    }// </editor-fold>//GEN-END:initComponents

    private void loadButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_loadButtonActionPerformed
        loggerInstance.log(getClass(), "Load button clicked, chosen attack: " + attackListModel.getSelectedItem(),
        ...
        loggerInstance.log(selectedAttack.getClass(), "Loading attack information and additional UI components...",
                Logger.LogLevel.DEBUG);
    ...
    private void attackButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_attackButtonActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(new JFrame(), e.getMessage(), bundle.getString("ATTACK_PREPARATION_FAILED"),
