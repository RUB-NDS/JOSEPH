        ...
        if (formatText.isSelected()) {
            ...
            if (!content.isEmpty()) {
                try {
                    ...
                    loggerInstance.log(getClass(), "Formatting from hex to text failed: " + e.getMessage(),
        ...
        if (formatHex.isSelected()) {
            ...
            if (!content.isEmpty()) {
                try {
                    ...
                    loggerInstance.log(getClass(), "Formatting from text to hex failed: " + e.getMessage(),
                            Logger.LogLevel.ERROR);
                    inputTextarea.setText("");
                }
            }
