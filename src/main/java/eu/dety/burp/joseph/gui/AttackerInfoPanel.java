...
public class AttackerInfoPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        attackerInfoContentLabel
                .setText("<html><b>How to:</b><ul><li>Navigate to the PROXY tab</li><li>Right click on a (marked) request with a JOSE value</li><li>Click \"Send to JOSEPH\"</li></html>");
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                layout.createSequentialGroup().addComponent(attackerInfoHeadlineLabel).addGap(0, 173, Short.MAX_VALUE))
                                        .addComponent(jSeparator1, javax.swing.GroupLayout.Alignment.LEADING)).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout.createSequentialGroup().addContainerGap().addComponent(attackerInfoHeadlineLabel)
